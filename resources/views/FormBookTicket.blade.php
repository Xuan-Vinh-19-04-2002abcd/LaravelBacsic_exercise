...
<form action="" method="POST"  enctype="multipart/form-data">
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="form-group">
        ...
        <input type="text" name = "price_room">
      </div>
    </div>
        <input type="file" name = "img_room">
 ...
 {{-- Lấy thư mục từ public phải có asset phía trước --}}
 {{-- $img = $request -> flie('roomIamge');
